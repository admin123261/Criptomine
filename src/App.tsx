...
import { registerServiceWorker, requestNotificationPermission, checkForNewMessages, checkForNewNotifications, resetNotificationCounters, sendPushNotification } from './notifications';
